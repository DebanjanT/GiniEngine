...
struct DiligentPBRMaterial {
    ...
    // Texture maps
    Ref<DiligentTexture> AlbedoMap;
    Ref<DiligentTexture> NormalMap;
    Ref<DiligentTexture> MetallicMap;
    Ref<DiligentTexture> RoughnessMap;
    Ref<DiligentTexture> AOMap;
    Ref<DiligentTexture> EmissiveMap;
...
public:
    ...
    // Texture management
    void SetAlbedoMap(Ref<DiligentTexture> texture);
    void SetNormalMap(Ref<DiligentTexture> texture);
    void SetMetallicMap(Ref<DiligentTexture> texture);
    void SetRoughnessMap(Ref<DiligentTexture> texture);
    void SetAOMap(Ref<DiligentTexture> texture);
    void SetEmissiveMap(Ref<DiligentTexture> texture);
    ...
    // Resource binding
    void Bind(Diligent::IShaderResourceBinding* resourceBinding, u32 materialSlot = 0);
    ...
    // Texture accessors
    Ref<DiligentTexture> GetAlbedoMap() const { return m_Material.AlbedoMap; }
    Ref<DiligentTexture> GetNormalMap() const { return m_Material.NormalMap; }
    Ref<DiligentTexture> GetMetallicMap() const { return m_Material.MetallicMap; }
    Ref<DiligentTexture> GetRoughnessMap() const { return m_Material.RoughnessMap; }
    Ref<DiligentTexture> GetAOMap() const { return m_Material.AOMap; }
    Ref<DiligentTexture> GetEmissiveMap() const { return m_Material.EmissiveMap; }
...
public:
    ...
    static Ref<DiligentMaterial> CreateMetalMaterial(const glm::vec3& albedo = glm::vec3(0.7f, 0.7f, 0.8f));
    static Ref<DiligentMaterial> CreatePlasticMaterial(const glm::vec3& albedo = glm::vec3(0.8f, 0.8f, 0.8f));
    static Ref<DiligentMaterial> CreateGlassMaterial(const glm::vec3& albedo = glm::vec3(0.1f, 0.1f, 0.1f));
    static Ref<DiligentMaterial> CreateEmissiveMaterial(const glm::vec3& emissive = glm::vec3(1.0f, 1.0f, 1.0f));
    
    // Utility materials
    static Ref<DiligentMaterial> CreateDebugMaterial(const glm::vec3& color = glm::vec3(1.0f, 0.0f, 0.0f));
    static Ref<DiligentMaterial> CreateWireframeMaterial(const glm::vec3& color = glm::vec3(0.0f, 1.0f, 0.0f));
    ...
    static Ref<DiligentMaterial> CreateFromTexture(Ref<DiligentTexture> albedoTexture);
    static Ref<DiligentMaterial> CreateFromTextures(Ref<DiligentTexture> albedo,
                                                   Ref<DiligentTexture> normal = nullptr,
                                                   Ref<DiligentTexture> metallic = nullptr,
                                                   Ref<DiligentTexture> roughness = nullptr,
                                                   Ref<DiligentTexture> ao = nullptr);
};
