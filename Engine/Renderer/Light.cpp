...
void LightManager::CreateDiligentLights() {
  // Diligent Engine not available, this is a no-op
  // OpenGL lighting is already functional
  m_HasDiligentResources = false;
}

void LightManager::UpdateDiligentLights() {
  // Diligent Engine not available, this is a no-op
  // OpenGL lighting updates are handled by the existing system
}

void LightManager::RegisterWithHybridManager() {
  // Diligent Engine not available, this is a no-op
  // OpenGL lighting is already functional
}
