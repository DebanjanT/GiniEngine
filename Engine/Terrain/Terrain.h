...
public:
    ...
    void GenerateFlat();
    void GenerateFromNoise(f32 frequency = 0.02f, f32 amplitude = 50.0f, i32 octaves = 4);
    ...
    // Painting
    void PaintHeight(f32 worldX, f32 worldZ, f32 radius, f32 strength, bool raise = true);
    ...
    void PaintMaterial(f32 worldX, f32 worldZ, f32 radius, f32 strength, u32 layerIndex);
    ...
    void SetHeightScale(f32 scale) { m_HeightScale = scale; RegenerateMesh(); }
    ...
    static Ref<Terrain> Create(u32 width = 256, u32 height = 256, f32 scale = 1.0f);
